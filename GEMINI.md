# Core Mandates (Foundational Instructions)
...
- **Coding Style:**
  - 기존 요구사항을 절대 누락하지 않는다.
  - 코드가 깊어지더라도 로직이 이상하게 변하지 않도록 주의하고 검토한다.
  - 기능 추가 시 전체 코드의 유기적 연결에 문제가 없는지 확인한다.
  - **Additive Development:** 코딩은 항상 기존 코드를 수정하기보다 기능을 추가하고 확장하여 "코드가 두꺼워지는" 방향으로 진행한다.
